#ifndef mulle__rbtree__debug_include_h__
#define mulle__rbtree__debug_include_h__

// this is a global symbol that is exposed, which can be used to detect
// if this library is available

#define HAVE_INCLUDE_MULLE__RBTREE__DEBUG
...
#include "_mulle-rbtree-debug-include.h"

#ifndef MULLE__RBTREE__DEBUG_GLOBAL
# ifdef MULLE__RBTREE__DEBUG_BUILD
#  define MULLE__RBTREE__DEBUG_GLOBAL    MULLE_C_GLOBAL
# else
#  if defined( MULLE__RBTREE_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE__RBTREE_INCLUDE_STATIC))
#   define MULLE__RBTREE__DEBUG_GLOBAL   MULLE_C_GLOBAL
#  else
#   define MULLE__RBTREE__DEBUG_GLOBAL   extern
#  endif
# endif
#endif
