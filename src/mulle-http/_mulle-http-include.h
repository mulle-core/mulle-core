...
#ifndef _mulle_http_include_h__
#define _mulle_http_include_h__

// To remove the following dependency (headers and library) completely:
//   `mulle-sde dependency remove mulle-c11`
// (Use 1C4D75E4-4213-4C4B-939B-58FF4124436C instead of mulle-c11, if there are duplicate entries)
//
