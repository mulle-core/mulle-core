#ifndef mulle__linkedlist_include_h__
#define mulle__linkedlist_include_h__

// this is a global symbol that is exposed, which can be used to detect
// if this library is available

#define HAVE_INCLUDE_MULLE__LINKEDLIST
...
#include "_mulle-linkedlist-include.h"

#ifndef MULLE__LINKEDLIST_GLOBAL
# ifdef MULLE__LINKEDLIST_BUILD
#  define MULLE__LINKEDLIST_GLOBAL    MULLE_C_GLOBAL
# else
#  if defined( MULLE__LINKEDLIST_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE__LINKEDLIST_INCLUDE_STATIC))
#   define MULLE__LINKEDLIST_GLOBAL   MULLE_C_GLOBAL
#  else
#   define MULLE__LINKEDLIST_GLOBAL   extern
#  endif
# endif
#endif
