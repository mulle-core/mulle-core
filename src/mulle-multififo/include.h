...
#ifdef MULLE_MULTIFIFO_BUILD
# define MULLE_MULTIFIFO_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_MULTIFIFO_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_MULTIFIFO_INCLUDE_STATIC))
#  define MULLE_MULTIFIFO_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE_MULTIFIFO_GLOBAL   extern
# endif
#endif
