...
#ifndef _mulle_url_include_h__
#define _mulle_url_include_h__

// To remove the following dependency (headers and library) completely:
//   `mulle-sde dependency remove mulle-c11`
// (Use 015D60E4-B623-48F3-A582-E6FD4D5A920F instead of mulle-c11, if there are duplicate entries)
//
